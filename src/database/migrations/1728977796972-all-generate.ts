...
export class allGenerate1728977796972 implements MigrationInterface {
  name = 'allGenerate1728977796972';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "role" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(100) NOT NULL, "description" character varying NOT NULL, CONSTRAINT "UQ_ae4578dcaed5adff96595e61660" UNIQUE ("name"), CONSTRAINT "UQ_ae4578dcaed5adff96595e61660" UNIQUE ("name"), CONSTRAINT "PK_b36bcfe02fc8de3c57a8b2391c2" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "user_profile" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f44d0cd18cfd80b0fed7806c3b7" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "user_bank_detail" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5aa4e921201c1e9c89b0bc94b03" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "user_document" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_18a41ed5aafb9732cfa62c8debd" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "project" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" text NOT NULL, "status" character varying(20) NOT NULL, "natureOfWork" character varying(30) NOT NULL, "fiscalYear" integer NOT NULL, "startingDate" date NOT NULL, "endingDate" date NOT NULL, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "task_group" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" text, "tasksId" integer, CONSTRAINT "PK_465a127df1ace09f377dd2eef6f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "task" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" text, "startTime" TIMESTAMP, "endTime" TIMESTAMP, "dueDate" TIMESTAMP, "reporterId" integer NOT NULL, "groupId" integer, "projectId" integer, "parentTaskId" integer, CONSTRAINT "UQ_20f1f21d6853d9d20d501636ebd" UNIQUE ("name"), CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_tasks" ("taskId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_07df033b0b61ee58ded3168bf2a" PRIMARY KEY ("taskId", "userId"))`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_eff2f1ef189a7952bc6294a1da" ON "user_tasks" ("taskId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_83e94423ca0675e4ac503d8641" ON "user_tasks" ("userId") `
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_cb5415b5e54f476329451212e9" ON "user_project" ("projectId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b88a18e4faeea3bce60d70a4ae" ON "user_project" ("userId") `
    );
    await queryRunner.query(
      `ALTER TABLE "task_group" ADD CONSTRAINT "FK_9f422b1eb79d9d30ce680809556" FOREIGN KEY ("tasksId") REFERENCES "task"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "task" ADD CONSTRAINT "FK_b8e1728a46f2cbb7b937011ae4f" FOREIGN KEY ("groupId") REFERENCES "task_group"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "task" ADD CONSTRAINT "FK_8bf6d736c49d48d91691ea0dfe5" FOREIGN KEY ("parentTaskId") REFERENCES "task"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_tasks" ADD CONSTRAINT "FK_eff2f1ef189a7952bc6294a1da5" FOREIGN KEY ("taskId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "user_tasks" ADD CONSTRAINT "FK_83e94423ca0675e4ac503d86413" FOREIGN KEY ("userId") REFERENCES "task"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "user_project" ADD CONSTRAINT "FK_cb5415b5e54f476329451212e9b" FOREIGN KEY ("projectId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "user_project" ADD CONSTRAINT "FK_b88a18e4faeea3bce60d70a4ae3" FOREIGN KEY ("userId") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_tasks" DROP CONSTRAINT "FK_83e94423ca0675e4ac503d86413"`
    );
    await queryRunner.query(
      `ALTER TABLE "user_tasks" DROP CONSTRAINT "FK_eff2f1ef189a7952bc6294a1da5"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "task_group" DROP CONSTRAINT "FK_9f422b1eb79d9d30ce680809556"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b88a18e4faeea3bce60d70a4ae"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cb5415b5e54f476329451212e9"`
    );
    await queryRunner.query(`DROP TABLE "user_project"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_83e94423ca0675e4ac503d8641"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_eff2f1ef189a7952bc6294a1da"`
    );
